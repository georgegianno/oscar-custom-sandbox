...
--> The ranges have been customized. 
    ...
    4. A search has been added to the range dashboard page with title search option and 'Show standalone and parents only' option that filters parents and standalone
       products.There is an ordering option for products in range update page in dashboard and a button to view live the range page, which is missing from oscar.
